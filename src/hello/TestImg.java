...
public class TestImg {
    public static void main(String[] args) throws IOException {
        String path = "E:/testImg/3.jpg";//导入的图片
//        String path = "E:/testImg/1.png";
        String base = ".,-*o=+'";//将会用这个字符串里的字符填充图片
//        String base = "love";
        BufferedImage image = ImageIO.read(new File(path));//读入图片，并用图片缓冲区对象来接收

        //双层for循环，遍历图片
        for (int y = 0; y < image.getHeight(); y+=25) {//先竖向遍历，再横向遍历，即一行一行的找，后面也会一行一行的打印
